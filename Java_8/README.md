...
|9|Optional class |1. To provide a type-level solution to represent optional value instead of null value 2. to handle the absence of a value 3. to avoid NullPointerException |
