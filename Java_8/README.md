...
|9|Optional class |1. To provide a type-level solution to represen optional values instead of null references 2. to handle the absence of a value 3. to avoid NullPointerException |
